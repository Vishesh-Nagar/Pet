...
!(function (a, b) {
    ...
    var Browser = (function (a) {
            ...
            return {
                IE:
                    !(!window.attachEvent || -1 !== a.indexOf("Opera")) &&
                    b("MSIE "),
                Opera:
                    a.indexOf("Opera") > -1 &&
                    ((!!window.opera &&
        ...
        Fit = {
            within: function (a, b) {
                for (
                    ...
                    f > 0 &&
                    ((g.width && d.width > a.width) ||
                        (g.height && d.height > a.height));
                    ...
                    this._polling = setTimeout(
                        a.proxy(function () {
                            ...
                            if (
                                ...
                                this._time >=
                                    this.options.intervals[this._ipos][0])
                            ) {
                                if (!this.options.intervals[this._ipos + 1])
                                    return void (
                                        "function" == a.type(this._timeout) &&
                                        this._timeout()
                                    );
                                this._ipos++,
                                    (this._delay =
    ...
    (Spinner.supported = Support.css.transform && Support.css.animation),
        $.extend(Spinner.prototype, {
            ...
            setOptions: function (a) {
                this.options = $.extend({ show: 200, hide: 200 }, a || {});
            },
            build: function () {
                if (!this._build) {
                    this._rotate.html("");
                    var a =
                        (2 * (this.options.length + this.options.radius),
                    ...
                    this._rotate.append(
                        (b = $("<div>")
                            ...
                            .append(
                                (c = $("<div>").addClass(
                                    this.classPrefix + "spinner-line"
                                ))
                            ))
                    );
                    var d = parseInt($(c).css("z-index"));
                    (this.lines = d),
                        c.css({ "z-index": "inherit" }),
                        b.remove(),
                        a || this.element.hide();
                    for (var e, f = 0; d > f; f++) {
                        var b, c;
                        this._rotate.append(
                            ...
                            (e = e || c.css("color")),
                            c.css({ background: e }),
                            b.css({ opacity: ((1 / d) * (f + 1)).toFixed(2) });
                        var g = {};
                        (g[Support.css.prefixed("transform")] =
                            "rotate(" + (360 / d) * (f + 1) + "deg)"),
                            b.css(g);
                    }
                    this._build = !0;
                }
            ...
            start: function () {
                var a = {};
                (a[Support.css.prefixed("animation")] =
                    this.classPrefix +
            ...
            create: function (a, b, c) {
                ...
                var d = a.skin
                        ? $.extend(
                              {},
                              Strip.Skins[a.skin] ||
                                  Strip.Skins[this.defaults.skin]
                          )
                        : {},
    ...
    var Pages = {
            ...
            add: function (a) {
                this.uid++,
                    ...
                    $.each(
                        a,
                        $.proxy(function (a, b) {
                            this.pages[this.uid].push(
                                new Page(b, a + 1, this.views.length)
                            );
                        }, this)
                    );
            },
            show: function (a, b) {
                ...
                return this.page && this.page.uid == c.uid
                    ? void (
                          c.view.options.toggle &&
                          (Window.hide(), (this.page = null))
                      )
                    : (Pages.setActiveClass(c),
                      (this.page = c),
            ...
            setActiveClass: function (a) {
                ...
                if (b) {
                    ...
                    var c = $(b).attr("data-strip-group");
                    c &&
                        $('.strip[data-strip-group="' + c + '"]').addClass(
                            "strip-active-group"
                        );
                }
            },
                ...
                $.extend(a.prototype, {
                    ...
                    create: function () {
                        if (!this._created) {
                            ...
                            var a =
                                this.view.options.position && this._total > 1;
                            switch (
                                ((this.view.caption || a) &&
                                    (this.element.append(
                                        (this.info = $("<div>")
                    ...
                    insertVideo: function (a) {
                        ...
                        var b =
                            ...
                            e = {
                                vimeo:
                                    b +
                                    "//player.vimeo.com/video/{id}?{queryString}",
                                youtube:
                                    b +
                                    "//www.youtube.com/embed/{id}?{queryString}",
                            },
                            f = e[this.view.type]
                        ...
                        b.queue([]),
                            ...
                            b.queue(
                                $.proxy(function (a) {
                                    this.view.options.spinner &&
                                        Window._spinner &&
                                        (Window.setSpinnerSkin(
                                            this.view.options.skin
                                        ),
                                        Window._spinner.setOptions(
                                            this.view.options.effects.spinner
                                        ),
                                ...
                                $.proxy(function (a) {
                                    ...
                                    this._show(function () {
                                        ...
                                        Window._showUIOnResize &&
                                            (Window.showUI(null, e),
                                            (Window._showUIOnResize = !1)),
                    ...
                    _getDimensionsFitToView: function () {
                        var a = $.extend({}, this.dimensions),
                            ...
                            c = this.view.options;
                        return (
                            c.maxWidth && (a.width = c.maxWidth),
                            c.maxHeight && (a.heigth = c.maxHeight),
                            (b = Fit.within(a, b))
                        );
                    },
                    ...
                    fitToWindow: function () {
                        ...
                        var h = Window.element,
                            i =
                                "width" === f
                                    ? parseInt(h.css("min-width")) > 0
                                    : parseInt(h.css("min-height")) > 0,
                            j = i
                                ? 0
                                : parseInt(
                                      h.css(
                        ...
                        if (p) {
                            ...
                            var s = a.is(":visible");
                            if ((s || a.show(), "width" === f)) {
                                a.css({ width: i ? c.width : m.width + k });
                                var t = d.height;
                                o.hide(),
                                    (q = p.outerHeight()),
                                    o.show(),
                                ...
                                for (
                                    ...
                                    a.css({ width: m.width + k - w }),
                                        (v = q),
                                        o.hide(),
                                        (q = p.outerHeight()),
                                        (u = Math.max(
                                            this.caption
                                                ? this.caption.outerWidth() + k
                                                : 0,
                                            this.position
                                                ? this.position.outerWidth() + k
                                                : 0
                                        )),
                                        o.show(),
                                        q === v && u <= m.width + k - w
                        ...
                        Browser.IE &&
                            ...
                            this.playerIframe && this.playerIframe.attr(n),
                            (this.contentDimensions = n),
                            (this.width = A.width),
        ...
        Window = {
                ...
                Spinner.supported &&
                    ($(document.body).append(
                        (this.spinnerMove = $("<div>")
                            ...
                            .append(
                                (this.spinner =
                                    $("<div>").addClass("strp-spinner"))
                            ))
                    ),
                    (this._spinner = new Spinner(this.spinner)),
                    (this._spinnerMoveSkinless =
                        this.spinnerMove[0].className)),
                    $(document.body).append(
                        (this.element = $("<div>")
                            .addClass("strp-window strp-measured")
                            .append(
                                (this._pages =
                                    $("<div>").addClass("strp-pages"))
                            )
                            .append(
                                (this._previous = $("<div>")
                            ...
                            .append(
                                (this._close = $("<div>")
                                    ...
                                    .append(
                                        $("<div>").addClass("strp-close-icon")
                                    ))
                            ))
                    ),
                    Pages.initialize(this._pages),
                    Support.mobileTouch &&
                        this.element.addClass("strp-mobile-touch"),
            ...
            setSkin: function (a) {
                this._skin &&
                    ...
                    this.element.addClass("strp-window-skin-" + a),
                    (this._skin = a);
            },
            setSpinnerSkin: function (a) {
                this.spinnerMove &&
                    ...
                    this.spinnerMove.addClass("strp-spinner-move-skin-" + a),
                    this._spinner.refresh(),
                    (this._spinnerSkin = a));
            },
            startObservingResize: function () {
                this._isObservingResize ||
                    ((this._onWindowResizeHandler = $.proxy(
            ...
            _onWindowResize: function () {
                var a;
                (a = Pages.page) &&
                    (a.animated || a.animatingWindow
                        ? (a.fitToWindow(), a.show())
                        : (a.fitToWindow(),
                          this.resize(a.z, null, 0),
            ...
            resize: function (a, b, c) {
                ...
                var g,
                    h = Window.element["outer" + e]();
                if (0 === h)
                    (g = this.view.options.effects.window.show),
            ...
            adjustPrevNext: function (a, b) {
                if (this.view && Pages.page) {
                    ...
                    this._previous.attr({ style: e }), d || this.element.hide();
            ...
            setSide: function (a, b) {
                ...
                if (this.visible) {
                    var c = this.view
                        ? this.view.options.effects.window.hide
                        : 0;
                    this.hideUI(null, c),
                        this.unbindUI(),
                        this.resize(
            ...
            _setSide: function (a, b) {
                ...
                var c = this.getOrientation(),
                    d = this.element;
                this.spinnerMove && (d = d.add(this.spinnerMove)),
                    d
            ...
            startLoading: function () {
                this._spinner &&
                    (this.spinnerMove.show(), this._spinner.show());
            },
            stopLoading: function () {
                if (this._spinner) {
                ...
                (this._position = a),
                    ...
                    (this.page = Pages.show(
                        ...
                        $.proxy(function () {
                            ...
                            "function" === $.type(c) && c.call(Strip, a),
                                b && b();
                        }, this)
                    ));
            },
                        ...
                        b.queue(
                            $.proxy(function (a) {
                                this._safeResetsAfterSwitchSide(),
                                    ...
                                    (this._position = -1);
                                var b =
                                    this.view && this.view.options.afterHide;
                                "function" === $.type(b) && b.call(Strip),
                                    (this.view = null),
                                    a();
                            }, this)
                        ),
            ...
            bindUI: function () {
                this.unbindUI(),
                    Support.mobileTouch ||
                        ...
                        this.element.on(
                            "mousemove",
                            (this._mousemoveUIHandler = $.proxy(function (a) {
                                var b = a.pageX,
                                    c = a.pageY;
                                this._hoveringNav ||
                                    (c === this._y && b === this._x) ||
                        ...
                        this._pages
                            .on(
                                "mousemove",
                                ".strp-container",
                                (this._onMouseMoveHandler = $.proxy(
                                    this._onMouseMove,
                                    this
                                ))
                            )
                            .on(
                                "mouseleave",
                                ".strp-container",
                                (this._onMouseLeaveHandler = $.proxy(
                                    this._onMouseLeave,
                                    this
                                ))
                            )
                            .on(
                                "mouseenter",
                                ".strp-container",
                                (this._onMouseEnterHandler = $.proxy(
                                    this._onMouseEnter,
                                    this
                                ))
                            ),
                ...
                this._showUIHandler &&
                    ...
                    this.element
                        .off(
                            "mouseenter",
                            ".strp-nav",
                            this._onNavMouseEnterHandler
                        )
                        .off(
                            "mouseleave",
                            ".strp-nav",
                            this._onNavMouseLeaveHandler
                        ),
            ...
            _onMouseMove: function (a) {
                var b = this._getEventSide(a),
                    c = b.toLowerCase();
                this.element[(this["may" + b]() ? "add" : "remove") + "Class"](
                    "strp-hovering-clickable"
                ),
                    this._previous[("next" !== c ? "add" : "remove") + "Class"](
                        "strp-nav-previous-hover strp-nav-hover"
                    ),
                    this._next[("next" === c ? "add" : "remove") + "Class"](
            ...
            hideUI: function (a, b) {
                ...
                "number" === $.type(b) && (d = b),
                    c.stop(!0).fadeOut(d, "stripEaseOutSine", function () {
                        "function" === $.type(a) && a();
                    });
            },
        ...
        _Strip = {
            ...
            show: function (object) {
                if (this._disabled)
                    return void this.showFallback.apply(
                        _Strip,
