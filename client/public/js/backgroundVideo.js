...
(function (root, factory) {
    ...
    class BackgroundVideo {
        ...
        init(element, iteration) {
            ...
            if (this.options && this.options.onBeforeReady())
                this.options.onBeforeReady();
        ...
        bindEvents() {
            ...
            window.addEventListener(
                "resize",
                this.setWindowDimensions.bind(this)
            );
        }
        ...
        positionObject() {
            ...
            const transformStyle = this.options.has3d
        ...
        setVideoWrap(iteration) {
            ...
            this.options.bvVideoWrap = document.querySelector(
                `.${this.options.bvVideoWrapClass}`
            );
        }
